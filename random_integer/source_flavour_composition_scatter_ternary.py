...
for i in range(N):
    t12.append(r.uniform(T12-sigma*sig12down,T12+sigma*sig12up))
    t23.append(r.uniform(T23-sigma*sig23down,T23+sigma*sig23up))
    t13.append(r.uniform(T13-sigma*sig13down,T13+sigma*sig13up))
...
p.axis('off')
d.scatter(data1,marker='.', color='aqua', alpha=0.01,
          label=r"uncertainty of $(\frac{1}{2},\frac{1}{2},0)$",s=50)
d.scatter(data2,marker='.', color='greenyellow', alpha=0.01, 
          label=r"uncertainty of $(1,0,0)$",s=50)
d.scatter(data3,marker='.', color='green', alpha=0.01, 
          label=r"uncertainty of $(\frac{1}{3},\frac{2}{3},0)$",s=50)
d.scatter(data4,marker='.', color='yellow', alpha=0.01, 
          label=r"uncertainty of $(0,1,0)$",s=50)
d.scatter(data5,marker='.',color='Aquamarine',alpha=0.01,
          label=r"uncertainty of$(\frac{2}{3},\frac{1}{2},0)$",s=50)
...
"""wriitng into files"""
#with open('110_%ssig.txt' %int(sigma), 'w') as f:
#    fieldnames = ['x', 'y','z']
...
#        
#with open('100_%ssig.txt' %int(sigma), 'w') as f:
#    fieldnames = ['x', 'y','z']
#    writer = csv.DictWriter(f, fieldnames=fieldnames)
#
#    writer.writeheader()
...
#        
#with open('120_%ssig.txt' %int(sigma), 'w') as f:
#    fieldnames = ['x', 'y','z']
#    writer = csv.DictWriter(f, fieldnames=fieldnames)
#
#    writer.writeheader()
...
#
#with open('010_%ssig.txt' %int(sigma), 'w') as f:
#    fieldnames = ['x', 'y','z']
#    writer = csv.DictWriter(f, fieldnames=fieldnames)
#
#    writer.writeheader()
...
#
#with open('210_%ssig.txt' %int(sigma), 'w') as f:
#    fieldnames = ['x', 'y','z']
#    writer = csv.DictWriter(f, fieldnames=fieldnames)
#
#    writer.writeheader()
