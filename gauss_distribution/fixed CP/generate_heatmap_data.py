...
with open('110fixedCP.txt','r')as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open('120fixedCP.txt','r')as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open('100fixedCP.txt','r')as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open('010fixedCP.txt','r')as f:
    reader = csv.DictReader(f)
    for row in reader:
...
with open('210fixedCP.txt','r')as f:
    reader = csv.DictReader(f)
    for row in reader:
