...
#
"""wriitng into files"""
with open('110fixedCP.txt', 'w') as f:
    fieldnames = ['x', 'y','z']
...
with open('100fixedCP.txt', 'w') as f:
    fieldnames = ['x', 'y','z']
    writer = csv.DictWriter(f, fieldnames=fieldnames)
...
with open('120fixedCP.txt', 'w') as f:
    fieldnames = ['x', 'y','z']
    writer = csv.DictWriter(f, fieldnames=fieldnames)
...
with open('010fixedCP.txt', 'w') as f:
    fieldnames = ['x', 'y','z']
    writer = csv.DictWriter(f, fieldnames=fieldnames)
...
with open('210fixedCP.txt', 'w') as f:
    fieldnames = ['x', 'y','z']
    writer = csv.DictWriter(f, fieldnames=fieldnames)
